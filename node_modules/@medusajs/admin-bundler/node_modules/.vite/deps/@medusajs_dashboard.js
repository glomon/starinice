...
import {
  useReturnReasons
} from "./chunk-PB7CITRD.js";
import {
  ProgressBar
} from "./chunk-TCA2UD3E.js";
import "./chunk-PCCLBZD7.js";
import {
  Thumbnail
} from "./chunk-FLIRDJLF.js";
import {
  AnimatePresence
} from "./chunk-VXOI3VOA.js";
import {
  require_debounce
} from "./chunk-YY2T57I2.js";
import "./chunk-LDWUUPO4.js";
import {
  matchSorter
} from "./chunk-TRCZ5H5Y.js";
import {
  I18n
} from "./chunk-VZ5FWHMY.js";
import {
  Skeleton
...
import {
  FilePreview
} from "./chunk-XF6UTGU4.js";
import "./chunk-EX7ZLLWN.js";
import {
  ConditionalTooltip
} from "./chunk-FURIVWWB.js";
import {
  we
} from "./chunk-R435OOKX.js";
import {
  languages
} from "./chunk-O2SHVWJ7.js";
import {
  formatDistance
} from "./chunk-QJMXPFFL.js";
...
var Providers = ({ api, children }) => {
  return (0, import_jsx_runtime3.jsx)(TooltipProvider, { children: (0, import_jsx_runtime3.jsx)(DashboardExtensionProvider, { api, children: (0, import_jsx_runtime3.jsx)(HelmetProvider, { children: (0, import_jsx_runtime3.jsx)(QueryClientProvider, { client: queryClient, children: (0, import_jsx_runtime3.jsxs)(ThemeProvider, { children: [
        ...
        return (0, import_jsx_runtime4.jsxs)(CommandGroup, { heading: group.title, children: [
          ...
          group.hasMore && area === "all" && (0, import_jsx_runtime4.jsx)(
            CommandItem,
            {
              ...
              children: (0, import_jsx_runtime4.jsxs)("div", { className: "text-ui-fg-muted flex items-center gap-x-3", children: [
                ...
                (0, import_jsx_runtime4.jsx)(Text, { size: "small", leading: "compact", weight: "plus", children: t2("app.search.showMore") })
              ] })
            }
          ),
          group.hasMore && area === group.area && (0, import_jsx_runtime4.jsx)(
            CommandItem,
            {
              ...
              children: (0, import_jsx_runtime4.jsxs)("div", { className: "text-ui-fg-muted flex items-center gap-x-3", children: [
                (0, import_jsx_runtime4.jsx)(Plus, {}),
                (0, import_jsx_runtime4.jsx)(Text, { size: "small", leading: "compact", weight: "plus", children: t2("app.search.loadMore", {
                  count: Math.min(
                      ...
                      return (0, import_jsx_runtime4.jsxs)(
                        "div",
                        {
                          ...
                          children: [
                            ...
                            index < (((_a3 = item.keys.Mac) == null ? void 0 : _a3.length) || 0) - 1 && (0, import_jsx_runtime4.jsx)("span", { className: "txt-compact-xsmall text-ui-fg-subtle", children: t2("app.keyboardShortcuts.then") })
                          ]
                        },
                        index
                      );
  ...
  return (0, import_jsx_runtime4.jsx)(dist_exports2.Root, { ...props, children: (0, import_jsx_runtime4.jsxs)(dist_exports2.Portal, { children: [
    ...
    (0, import_jsx_runtime4.jsxs)(
      dist_exports2.Content,
      {
        ...
        children: [
          (0, import_jsx_runtime4.jsx)(dist_exports2.Title, { className: "sr-only", children: t2("app.search.title") }),
          (0, import_jsx_runtime4.jsx)(dist_exports2.Description, { className: "sr-only", children: t2("app.search.description") }),
          ...
          (0, import_jsx_runtime4.jsx)("div", { className: "bg-ui-bg-field text-ui-fg-subtle flex items-center justify-end border-t px-4 py-3", children: (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-x-3", children: [
            (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-x-2", children: [
              (0, import_jsx_runtime4.jsx)(Text, { size: "xsmall", leading: "compact", children: t2("app.search.navigation") }),
            ...
            (0, import_jsx_runtime4.jsxs)("div", { className: "flex items-center gap-x-2", children: [
              (0, import_jsx_runtime4.jsx)(Text, { size: "xsmall", leading: "compact", children: t2("app.search.openResult") }),
              (0, import_jsx_runtime4.jsx)(Kbd, { className: "bg-ui-bg-field-component", children: "↵" })
            ] })
          ] }) })
        ]
            ...
            children: (0, import_jsx_runtime4.jsx)(
              DropdownMenu.RadioGroup,
              {
                ...
                children: SEARCH_AREAS.map((area2) => (0, import_jsx_runtime4.jsxs)(import_react9.Fragment, { children: [
                  ...
                  (0, import_jsx_runtime4.jsx)(DropdownMenu.RadioItem, { value: area2, children: t2(`app.search.groups.${area2}`) }),
...
var CommandEmpty = (0, import_react9.forwardRef)((props, ref) => {
  ...
  return (0, import_jsx_runtime4.jsx)(we.Empty, { ref, className: "py-6 text-center text-sm", ...props, children: (0, import_jsx_runtime4.jsxs)("div", { className: "text-ui-fg-subtle flex min-h-[236px] flex-col items-center justify-center gap-y-3", children: [
    ...
    (0, import_jsx_runtime4.jsxs)("div", { className: "flex flex-col items-center justify-center gap-y-1", children: [
      (0, import_jsx_runtime4.jsx)(Text, { size: "small", weight: "plus", leading: "compact", children: props.q ? t2("app.search.noResultsTitle") : t2("app.search.emptySearchTitle") }),
      (0, import_jsx_runtime4.jsx)(Text, { size: "small", className: "text-ui-fg-muted", children: props.q ? t2("app.search.noResultsMessage") : t2("app.search.emptySearchMessage") })
    ] })
  ] }) });
});
      ...
      content: (0, import_jsx_runtime8.jsxs)("div", { className: "txt-compact-xsmall flex h-5 items-center justify-between gap-x-2 whitespace-nowrap", children: [
        ...
        (0, import_jsx_runtime8.jsx)("div", { className: "flex items-center gap-x-1", children: (_a2 = shortcut == null ? void 0 : shortcut.keys.Mac) == null ? void 0 : _a2.map((key, index) => {
          ...
          return (0, import_jsx_runtime8.jsxs)("div", { className: "flex items-center gap-x-1", children: [
            ...
            index < (((_a3 = shortcut.keys.Mac) == null ? void 0 : _a3.length) || 0) - 1 && (0, import_jsx_runtime8.jsx)("span", { className: "text-ui-fg-muted txt-compact-xsmall", children: t2("app.keyboardShortcuts.then") })
          ] }, index);
        }) })
      ] }),
      side: "right",
  ...
  return (0, import_jsx_runtime11.jsxs)(Drawer, { open, onOpenChange: handleOnOpen, children: [
    ...
    (0, import_jsx_runtime11.jsxs)(Drawer.Content, { children: [
      (0, import_jsx_runtime11.jsxs)(Drawer.Header, { children: [
        (0, import_jsx_runtime11.jsx)(Drawer.Title, { asChild: true, children: (0, import_jsx_runtime11.jsx)(Heading, { children: t2("notifications.domain") }) }),
        (0, import_jsx_runtime11.jsx)(Drawer.Description, { className: "sr-only", children: t2("notifications.accessibility.description") })
      ] }),
      (0, import_jsx_runtime11.jsx)(Drawer.Body, { className: "overflow-y-auto px-0", children: (0, import_jsx_runtime11.jsx)(
        InfiniteList,
        {
          ...
          renderEmpty: () => (0, import_jsx_runtime11.jsx)(NotificationsEmptyState, { t: t2 }),
...
var NotificationsEmptyState = ({ t: t2 }) => {
  return (0, import_jsx_runtime11.jsxs)("div", { className: "flex h-full flex-col items-center justify-center", children: [
    ...
    (0, import_jsx_runtime11.jsx)(Text, { size: "small", leading: "compact", weight: "plus", className: "mt-3", children: t2("notifications.emptyState.title") }),
    (0, import_jsx_runtime11.jsx)(
      Text,
      {
        size: "small",
      ...
      dist_exports2.Content,
      {
        ...
        children: [
          (0, import_jsx_runtime12.jsxs)("div", { className: "p-3", children: [
            ...
            (0, import_jsx_runtime12.jsx)(dist_exports2.Title, { className: "sr-only", children: t2("app.nav.accessibility.title") }),
            (0, import_jsx_runtime12.jsx)(dist_exports2.Description, { className: "sr-only", children: t2("app.nav.accessibility.description") })
          ] }),
          children
        ]
      }
...
var Logout = () => {
  ...
  return (0, import_jsx_runtime13.jsx)(DropdownMenu.Item, { onClick: handleLogout, children: (0, import_jsx_runtime13.jsxs)("div", { className: "flex items-center gap-x-2", children: [
    ...
    (0, import_jsx_runtime13.jsx)("span", { children: t2("app.menus.actions.logout") })
  ] }) });
};
      ...
      (0, import_jsx_runtime13.jsxs)("div", { className: "flex flex-col gap-y-3 px-6 py-4", children: [
        (0, import_jsx_runtime13.jsxs)("div", { className: "flex items-center justify-between", children: [
          (0, import_jsx_runtime13.jsxs)("div", { children: [
            (0, import_jsx_runtime13.jsx)(dist_exports2.Title, { asChild: true, children: (0, import_jsx_runtime13.jsx)(Heading, { children: t2("app.menus.user.shortcuts") }) }),
            ...
            children: [
              ...
              (0, import_jsx_runtime13.jsx)("div", { className: "flex items-center gap-x-1", children: (_a2 = shortcut.keys.Mac) == null ? void 0 : _a2.map((key, index2) => {
                ...
                return (0, import_jsx_runtime13.jsxs)("div", { className: "flex items-center gap-x-1", children: [
                  ...
                  index2 < (((_a3 = shortcut.keys.Mac) == null ? void 0 : _a3.length) || 0) - 1 && (0, import_jsx_runtime13.jsx)("span", { className: "txt-compact-xsmall text-ui-fg-subtle", children: t2("app.keyboardShortcuts.then") })
                ] }, index2);
              }) })
            ]
          },
...
var Logout2 = () => {
  ...
  return (0, import_jsx_runtime14.jsx)(DropdownMenu.Item, { onClick: handleLogout, children: (0, import_jsx_runtime14.jsxs)("div", { className: "flex items-center gap-x-2", children: [
    ...
    (0, import_jsx_runtime14.jsx)("span", { children: t2("app.menus.actions.logout") })
  ] }) });
};
var Header = () => {
  var _a2;
  ...
  return (0, import_jsx_runtime14.jsx)("div", { className: "px-3", children: (0, import_jsx_runtime14.jsxs)(
    "button",
    {
      ...
      children: [
        ...
        (0, import_jsx_runtime14.jsx)("div", { className: "flex-1 text-left", children: (0, import_jsx_runtime14.jsx)(Text, { size: "small", leading: "compact", weight: "plus", children: t2("app.search.label") }) }),
  ...
  return (0, import_jsx_runtime14.jsxs)("div", { children: [
    ...
    (0, import_jsx_runtime14.jsx)("div", { className: "flex flex-col gap-y-1 py-3", children: (0, import_jsx_runtime14.jsxs)(dist_exports.Root, { defaultOpen: true, children: [
      (0, import_jsx_runtime14.jsx)("div", { className: "px-4", children: (0, import_jsx_runtime14.jsx)(dist_exports.Trigger, { asChild: true, className: "group/trigger", children: (0, import_jsx_runtime14.jsxs)("button", { className: "text-ui-fg-subtle flex w-full items-center justify-between px-2", children: [
        (0, import_jsx_runtime14.jsx)(Text, { size: "xsmall", weight: "plus", leading: "compact", children: t2("app.nav.common.extensions") }),
  ...
  return (0, import_jsx_runtime16.jsx)("div", { className: "bg-ui-bg-subtle p-3", children: (0, import_jsx_runtime16.jsx)(
    Link,
    {
      ...
      children: (0, import_jsx_runtime16.jsxs)("div", { className: "flex items-center gap-x-2.5 px-2 py-1", children: [
        ...
        (0, import_jsx_runtime16.jsx)(Text, { leading: "compact", weight: "plus", size: "small", children: t2("app.nav.settings.header") })
      ] })
    }
  ) });
};
...
var RouteMap = [
  {
    element: (0, import_jsx_runtime17.jsx)(ProtectedRoute, {}),
    errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
    children: [
      {
        element: (0, import_jsx_runtime17.jsx)(MainLayout, {}),
        children: [
          {
            path: "/",
            errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
            lazy: () => import("./home-KSB2J7CS-X3JFWEYV.js")
          },
          {
            path: "/products",
            errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-list-L4LRPSR7-4K5RJVW4.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-create-W3YY3DVE-KHJVPYZO.js")
                  },
                  {
                    path: "import",
                    lazy: () => import("./product-import-54TGQZ7T-GYZYEAOA.js")
                  },
                  {
                    path: "export",
                    lazy: () => import("./product-export-OOGAPSQX-YVI6MVYL.js")
                  }
                ]
              },
              {
                ...
                errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
                lazy: async () => {
                  const { Breadcrumb, loader } = await import("./product-detail-NVKQD343-ZNUA2CCZ.js");
                  return {
                    Component: Outlet,
                    loader,
                    handle: {
                      breadcrumb: (match) => (0, import_jsx_runtime17.jsx)(Breadcrumb, { ...match })
                    }
                  };
                },
                children: [
                  {
                    path: "",
                    lazy: () => import("./product-detail-NVKQD343-ZNUA2CCZ.js"),
                    children: [
                      {
                        path: "edit",
                        lazy: () => import("./product-edit-ZTVKSM27-JAWUM32F.js")
                      },
                      {
                        path: "edit-variant",
                        lazy: () => import("./product-variant-edit-UGC7VGTZ-45NQSD62.js")
                      },
                      {
                        path: "sales-channels",
                        lazy: () => import("./product-sales-channels-PYCWV7AJ-OTHYNS6H.js")
                      },
                      {
                        path: "attributes",
                        lazy: () => import("./product-attributes-347UCFBA-DOVRD5JL.js")
                      },
                      {
                        path: "organization",
                        lazy: () => import("./product-organization-BZCTO25P-TO7YWY7Q.js")
                      },
                      {
                        path: "shipping-profile",
                        lazy: () => import("./product-shipping-profile-4BKER74M-CSDWICCH.js")
                      },
                      {
                        path: "media",
                        lazy: () => import("./product-media-OPFY2IHC-FTX3J7MB.js")
                      },
                      {
                        path: "prices",
                        lazy: () => import("./product-prices-GZZAUOCR-FMH7DNFM.js")
                      },
                      {
                        path: "options/create",
                        lazy: () => import("./product-create-option-77Q4VEBG-WZKETCGJ.js")
                      },
                      {
                        path: "options/:option_id/edit",
                        lazy: () => import("./product-edit-option-MJORFO4B-7WCMGF6Y.js")
                      },
                      {
                        path: "variants/create",
                        lazy: () => import("./product-create-variant-3GSLKU3L-HW6QVKXN.js")
                      },
                      {
                        path: "stock",
                        lazy: () => import("./product-stock-RMNMTMML-QJRNZ7XT.js")
                      },
                      {
                        path: "metadata/edit",
                        lazy: () => import("./product-metadata-Q3UCGHUG-XSNABDWE.js")
                      }
                    ]
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component: Component4, Breadcrumb, loader } = await import("./product-variant-detail-D6OSO3OF-WTUVRL3S.js");
                      return {
                    ...
                    children: [
                      ...
                      {
                        path: "manage-items",
                        lazy: () => import("./product-variant-manage-inventory-items-TLRIGQ5K-XMEQYAVY.js")
                      },
                      {
                        path: "metadata/edit",
                        lazy: () => import("./product-variant-metadata-A7K2H2NO-G2PSSFTW.js")
                      }
                    ]
                  }
                ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./category-list-PXNKFNWJ-QQ47EVSS.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./category-create-WQJY475T-RDIJWQO6.js")
                  },
                  {
                    path: "organize",
                    lazy: () => import("./category-organize-QCMGDSZ2-3GOU47XD.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./category-detail-JFIV6UIU-BAQVAZB6.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./category-edit-RKWZPNAB-2D45JGUF.js")
                  },
                  {
                    path: "products",
                    lazy: () => import("./category-products-UL64IL2O-6IUGDHY5.js")
                  },
                  {
                    path: "organize",
                    lazy: () => import("./category-organize-QCMGDSZ2-3GOU47XD.js")
                  ...
                  {
                    path: "metadata/edit",
                    lazy: () => import("./categories-metadata-FS45VNVT-ZQ275AMM.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./order-list-25DOVMQP-RNV7RMGI.js")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./order-detail-442IYDMT-QONDMYLK.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "fulfillment",
                    lazy: () => import("./order-create-fulfillment-XKU5E76V-VN2TOM5X.js")
                  },
                  {
                    path: "returns/:return_id/receive",
                    lazy: () => import("./order-receive-return-4I2M5W3F-D7SAMPVO.js")
                  },
                  {
                    path: "allocate-items",
                    lazy: () => import("./order-allocate-items-7HRMJY5V-EGXVDNTH.js")
                  },
                  {
                    path: ":f_id/create-shipment",
                    lazy: () => import("./order-create-shipment-BMSAQSHA-NRPH7NTB.js")
                  },
                  {
                    path: "returns",
                    lazy: () => import("./order-create-return-COVUYLIG-LHDZSJZI.js")
                  },
                  {
                    path: "claims",
                    lazy: () => import("./order-create-claim-SODPBIJ5-ENOVRWQW.js")
                  },
                  {
                    path: "exchanges",
                    lazy: () => import("./order-create-exchange-LJEM2Z6I-2GV25R36.js")
                  },
                  {
                    path: "edits",
                    lazy: () => import("./order-create-edit-KEIEV3FC-4H25KP3X.js")
                  },
                  {
                    path: "refund",
                    lazy: () => import("./order-create-refund-WVD26GN3-ZFX5SC44.js")
                  },
                  {
                    path: "transfer",
                    lazy: () => import("./order-request-transfer-5DGJNMOD-PZZYROHH.js")
                  },
                  {
                    path: "email",
                    lazy: () => import("./order-edit-email-OPV4ZOS4-ICLLEIB2.js")
                  },
                  {
                    path: "shipping-address",
                    lazy: () => import("./order-edit-shipping-address-UOPCQLGS-KESUF7KU.js")
                  },
                  {
                    path: "billing-address",
                    lazy: () => import("./order-edit-billing-address-BFHPDCYQ-M77GXWLP.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./order-metadata-4IYRANTV-2WIQETNY.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./promotion-list-YL47OSLH-ZLHE7JQF.js")
              },
              {
                path: "create",
                lazy: () => import("./promotion-create-3TPHAQQX-R4GKTGX2.js")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./promotion-detail-J2UOHDOW-EABUL55Y.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./promotion-edit-details-NXAE4DNG-K3TPB7BW.js")
                  },
                  {
                    path: "add-to-campaign",
                    lazy: () => import("./promotion-add-campaign-OCUROIGI-WDMMSK73.js")
                  },
                  {
                    path: ":ruleType/edit",
                    lazy: () => import("./edit-rules-RVTFTIZK-SE47ZC47.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./campaign-list-6K2UJEKS-YKQWXPAX.js"),
                children: []
              },
              {
                path: "create",
                lazy: () => import("./campaign-create-OHYCYUEH-YBDX7FJO.js")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./campaign-detail-XSOXBVZH-WTOGXNCW.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./campaign-edit-U6GDSJ6T-WIBFFY4O.js")
                  },
                  {
                    path: "configuration",
                    lazy: () => import("./campaign-configuration-AQW4CUU7-CZVABZQC.js")
                  },
                  {
                    path: "edit-budget",
                    lazy: () => import("./campaign-budget-edit-OYTR26B3-REGGAE42.js")
                  },
                  {
                    path: "add-promotions",
                    lazy: () => import("./add-campaign-promotions-2L4EPHIM-6SBPUOIW.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./collection-list-FB6VQQ5M-IPJN3UEN.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./collection-create-I5D44ZYM-5ATUUTPI.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./collection-detail-7EYTK5KL-4OXOAO3P.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./collection-edit-C62YPOSB-45DIM24I.js")
                  },
                  {
                    path: "products",
                    lazy: () => import("./collection-add-products-JDYECFXF-LMEPKMEU.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./collection-metadata-5HHQNOAJ-JXULJKN4.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./price-list-list-PCH6JHXA-IHXKXCNG.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./price-list-create-ZMBTT3NH-EHZVDLTG.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./price-list-detail-TCOLSR6L-OGPVQDRB.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./price-list-edit-RMAPKFMM-XL5BGK2S.js")
                  },
                  {
                    path: "configuration",
                    lazy: () => import("./price-list-configuration-TCVTV62B-ATRCH55U.js")
                  },
                  {
                    path: "products/add",
                    lazy: () => import("./price-list-prices-add-KC74UVGF-NKIFFODT.js")
                  },
                  {
                    path: "products/edit",
                    lazy: () => import("./price-list-prices-edit-ZSFEY2DV-2LTXQ42Y.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-list-ICD4KNSK-SKXAN7AL.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./customer-create-Y7YFUEFN-U2GX2CVR.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./customer-detail-P5TRS2GY-UCLB6IBN.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./customer-edit-TED44RMQ-MTEGDPG5.js")
                  },
                  {
                    path: "add-customer-groups",
                    lazy: () => import("./customers-add-customer-group-NEJ5SWWR-PEHA72ZF.js")
                  },
                  {
                  ...
                  {
                    path: "metadata/edit",
                    lazy: () => import("./customer-metadata-5QI6BYLW-A2U3BDIX.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./customer-group-list-XK52BCPY-4RJ4TZFQ.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./customer-group-create-NYGVDH5G-3QLVTC7Y.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./customer-group-detail-6LMMTO5B-KHDMMXEG.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./customer-group-edit-SXI5CIEK-DK2JGLZR.js")
                  },
                  {
                    path: "add-customers",
                    lazy: () => import("./customer-group-add-customers-UAOC5XE5-BEUBLMXX.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./customer-group-metadata-TPKKYDR3-JXTHZHLQ.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./reservation-list-3TBLLH4C-ZFHPCCAA.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./reservation-create-3OOUH473-46B2D7BV.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./reservation-detail-7ZZKM4BU-7EUEZKCI.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./edit-reservation-3XTK5CTO-D72CETPP.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./reservation-metadata-Q5RBGAOP-NNUXHIWI.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./inventory-list-YAEX6UUE-C4RTN5UK.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./inventory-create-ZL3UU5LS-VDBZ5YVO.js")
                  },
                  {
                    path: "stock",
                    lazy: () => import("./inventory-stock-EY6WJQVY-KDTS5O7B.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./inventory-detail-67W2UHHQ-UZ4YHLJH.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./edit-inventory-item-AD7WR3V6-ZTMVUHMZ.js")
                  },
                  {
                    path: "attributes",
                    lazy: () => import("./edit-inventory-item-attributes-RQPRXE3E-FP3JIJ2M.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./inventory-metadata-7PL5XRCS-MU7EP6AI.js")
                  },
                  {
                    path: "locations",
                    lazy: () => import("./manage-locations-S6D2JUZ6-KS6CYX6T.js")
                  },
                  {
                    path: "locations/:location_id",
                    lazy: () => import("./adjust-inventory-BKL45HGN-ODJ6RRGM.js")
                  }
                ]
              }
            ]
    ...
    children: [
      {
        ...
        element: (0, import_jsx_runtime17.jsx)(SettingsLayout, {}),
        children: [
          {
            index: true,
            errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
            lazy: () => import("./settings-FQUPXMWF-IFAR427X.js")
          },
          {
            path: "profile",
            errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
            lazy: () => import("./profile-detail-WOOZNL66-GMIYETI3.js"),
            handle: {
            ...
            children: [
              {
                path: "edit",
                lazy: () => import("./profile-edit-YLVHPLOG-4W5NQPEV.js")
              }
            ]
          },
          {
            path: "regions",
            errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
            element: (0, import_jsx_runtime17.jsx)(Outlet, {}),
            handle: {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./region-list-YXUEKTFB-EZ6QK72O.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./region-create-HX7T3NZ5-SR2JR5UM.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./region-detail-D4JJLGF6-T4QX5APF.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./region-edit-MVNYECPG-YFJUQBET.js")
                  },
                  {
                    path: "countries/add",
                    lazy: () => import("./region-add-countries-26DFS3K5-3VDBMMVT.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./region-metadata-LDGNEFNK-NK7BB5Y3.js")
                  }
                ]
              }
            ]
          },
          {
            path: "store",
            errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
            lazy: () => import("./store-detail-DUCILQW7-XCYLB6XW.js"),
            handle: {
            ...
            children: [
              {
                path: "edit",
                lazy: () => import("./store-edit-T4WGFJ6Z-U5JSTUZK.js")
              },
              {
                path: "currencies",
                lazy: () => import("./store-add-currencies-IXOGLJKT-TPHBVNLO.js")
              },
              {
                path: "metadata/edit",
                lazy: () => import("./store-metadata-G5WQCXQV-6L3JFUWA.js")
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./user-list-L2EE2SIO-JI3TKXHF.js"),
                children: [
                  {
                    path: "invite",
                    lazy: () => import("./user-invite-4NYOYD5L-V63KQW6V.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./user-detail-CMPPPDW4-SNSTNPFH.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./user-edit-IYZ7FBGN-ZMUSBHPV.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./user-metadata-32HQPUSZ-6SFUJGMP.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./sales-channel-list-QJKG3VN4-5VGV5ZJO.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./sales-channel-create-SNVWPMZE-C7RBIIN7.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./sales-channel-detail-K5VNGCHS-SKRILKCP.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./sales-channel-edit-SSLBCW4R-XQC26BTN.js")
                  },
                  {
                    path: "add-products",
                    lazy: () => import("./sales-channel-add-products-UPEB7LJJ-ZWM5H3EL.js")
                  },
                  {
                    path: "metadata/edit",
                    lazy: () => import("./sales-channel-metadata-QCCR6GPY-ALZJCGAN.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./location-list-CYLKB6HD-37X54C4G.js")
              },
              {
                path: "create",
                lazy: () => import("./location-create-VM7NJPQR-SH5KNVGX.js")
              },
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./shipping-profiles-list-G3PURS4A-WCYVXMTH.js"),
                    children: [
                      {
                        path: "create",
                        lazy: () => import("./shipping-profile-create-ENRP2FPI-2KW2W2NF.js")
                      }
                    ]
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component: Component4, Breadcrumb, loader } = await import("./shipping-profile-detail-7E5Y3TE7-EKIGQC6M.js");
                      return {
                        Component: Component4,
                        loader,
                        handle: {
                    ...
                    children: [
                      {
                        path: "metadata/edit",
                        lazy: () => import("./shipping-profile-metadata-5ZSX5G2D-KCNKYG7M.js")
                      }
                    ]
                  }
                ]
              },
              {
                path: ":location_id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./location-detail-MPGRHN23-G2JYBLBJ.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./location-edit-V6PUA3QW-JF2Z3LWU.js")
                  },
                  {
                    path: "sales-channels",
                    lazy: () => import("./location-sales-channels-RIRPFHTF-D2Q4VNMK.js")
                  },
                  {
                    path: "fulfillment-providers",
                    lazy: () => import("./location-fulfillment-providers-KS72LDSU-IEQXBWWL.js")
                  },
                  {
                    ...
                    children: [
                      {
                        ...
                        lazy: () => import("./location-service-zone-create-C75LX4EZ-EFRASUPV.js")
                      },
                      {
                        ...
                        children: [
                          {
                            path: "edit",
                            lazy: () => import("./location-service-zone-edit-DS6SJYLK-E7YO5JAM.js")
                          },
                          {
                            path: "areas",
                            lazy: () => import("./location-service-zone-manage-areas-V4FW7KPZ-7PKJ64HM.js")
                          },
                          {
                            ...
                            children: [
                              {
                                path: "create",
                                lazy: () => import("./location-service-zone-shipping-option-create-KHQ4ZOYX-PQML6SWJ.js")
                              },
                              {
                                path: ":so_id",
                                children: [
                                  {
                                    path: "edit",
                                    lazy: () => import("./location-service-zone-shipping-option-edit-DM5EFDP3-B22YWMXC.js")
                                  },
                                  {
                                    path: "pricing",
                                    lazy: () => import("./location-service-zone-shipping-option-pricing-IAS6HI3L-7WKFXW5T.js")
                                  }
                                ]
                              }
                            ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-tag-list-ZYDV2DPN-OY526FJ7.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-tag-create-DEXEBAXM-2B4LGGJB.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./product-tag-detail-OPTTTIGX-KTLT7WAR.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./product-tag-edit-MFBLY44A-OQEQNWDS.js")
                  }
                ]
              }
            ]
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./workflow-execution-list-2IRP7OES-GFFJEWZ4.js")
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./workflow-execution-detail-TD2XBDPN-ZKIARZNS.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./product-type-list-VYL67JJK-7LMFYXGV.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./product-type-create-5DUFWSNN-ZJMDDIYM.js")
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./product-type-detail-3B6RMAXQ-6B4AX247.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./product-type-edit-3Z4W6DUK-ZUONK75S.js")
                  }
                ]
              }
            ]
            ...
            children: [
              {
                ...
                children: [
                  {
                    path: "",
                    lazy: () => import("./api-key-management-list-DVVRSZMW-Y5Q7TJAF.js"),
                    children: [
                      {
                        path: "create",
                        lazy: () => import("./api-key-management-create-W6YEAUUP-OT43HIF4.js")
                      }
                    ]
                  }
                ]
              },
              {
                path: ":id",
                lazy: async () => {
                  const { Component: Component4, Breadcrumb, loader } = await import("./api-key-management-detail-WBWSQB2W-BR3VFTX5.js");
                  return {
                    Component: Component4,
                    loader,
                    handle: {
                ...
                children: [
                  {
                    path: "edit",
                    lazy: () => import("./api-key-management-edit-TRROTPQ7-XBH7623R.js")
                  },
                  {
                    path: "sales-channels",
                    lazy: () => import("./api-key-management-sales-channels-AKHDDKJA-DXYSETQI.js")
                  }
                ]
              }
            ]
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./tax-region-list-AYS4JBDG-FJ2UVQJB.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./tax-region-create-34Y47AZV-VHB3G5HA.js")
                  }
                ]
              },
              {
                ...
                handle: {
                  breadcrumb: (match) => (0, import_jsx_runtime17.jsx)(TaxRegionDetailBreadcrumb, { ...match })
                },
                children: [
                  {
                    path: "",
                    lazy: async () => {
                      const { Component: Component4 } = await import("./tax-region-detail-D4IZ477X-7ZM7SARE.js");
                      return {
                        Component: Component4
                      };
                    },
                    children: [
                      {
                        ...
                        lazy: () => import("./tax-region-province-create-SWSIZ2S6-5WBPTMUK.js")
                      },
                      {
                        path: "overrides/create",
                        lazy: () => import("./tax-region-tax-override-create-V5LPJTYD-K3KLEJ4Y.js")
                      },
                      {
                        path: "overrides/:tax_rate_id/edit",
                        lazy: () => import("./tax-region-tax-override-edit-7PWKI5ZI-K4DNO2JM.js")
                      },
                      {
                        path: "tax-rates/create",
                        lazy: () => import("./tax-region-tax-rate-create-BCQHMSAU-BHBEYYEB.js")
                      },
                      {
                        path: "tax-rates/:tax_rate_id/edit",
                        lazy: () => import("./tax-region-tax-rate-edit-PBTATWXH-XBHP2PPB.js")
                      }
                    ]
                  },
                  {
                    ...
                    lazy: async () => {
                      const { Component: Component4, Breadcrumb, loader } = await import("./tax-region-province-detail-GUPRWEB7-62PEAFGG.js");
                      return {
                        Component: Component4,
                        loader,
                        handle: {
          ...
          },
          {
            ...
            children: [
              {
                path: "",
                lazy: () => import("./return-reason-list-XMVB4QQS-L5LHKAZL.js"),
                children: [
                  {
                    path: "create",
                    lazy: () => import("./return-reason-create-GZJMCRPO-DOQBB23T.js")
                  },
                  {
                    path: ":id",
                    children: [
                      {
                        path: "edit",
                        lazy: () => import("./return-reason-edit-CV23YIAF-JPGE27XV.js")
                      }
                    ]
                  }
                ]
  ...
  {
    element: (0, import_jsx_runtime17.jsx)(PublicLayout, {}),
    children: [
      {
        errorElement: (0, import_jsx_runtime17.jsx)(ErrorBoundary, {}),
        children: [
          {
            path: "/login",
            lazy: () => import("./login-V3O7N2XA-GXA5BVOC.js")
          },
          {
            path: "/reset-password",
            lazy: () => import("./reset-password-BNC2OI6E-XK26WAEO.js")
          },
          {
            path: "/invite",
            lazy: () => import("./invite-W2J3H5L6-DGRFBKCN.js")
          },
          {
            path: "*",
            lazy: () => import("./no-match-YRNHGOT3-NBMYJ5AA.js")
          }
        ]
      }
    ]
...
var RouterProvider2 = () => {
  return (0, import_jsx_runtime18.jsx)(RouterProvider, { router });
};
function App() {
  ...
  return (0, import_jsx_runtime19.jsx)(Providers, { api: manager.api, children: (0, import_jsx_runtime19.jsx)(RouterProvider2, {}) });
}
var app_default = App;
export {
