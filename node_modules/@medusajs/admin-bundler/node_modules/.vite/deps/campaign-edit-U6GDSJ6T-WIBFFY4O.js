...
// node_modules/@medusajs/dashboard/dist/campaign-edit-U6GDSJ6T.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var EditCampaignSchema = objectType({
  name: stringType(),
  description: stringType().optional(),
  campaign_identifier: stringType().optional(),
  starts_at: dateType().optional(),
  ends_at: dateType().optional()
});
    ...
    (0, import_jsx_runtime.jsx)(RouteDrawer.Body, { children: (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col gap-y-4", children: [
      ...
      (0, import_jsx_runtime.jsx)(
        Form.Field,
        {
          ...
          render: ({ field }) => {
            return (0, import_jsx_runtime.jsxs)(Form.Item, { children: [
              (0, import_jsx_runtime.jsx)(Form.Label, { children: t2("campaigns.fields.identifier") }),
              (0, import_jsx_runtime.jsx)(Form.Control, { children: (0, import_jsx_runtime.jsx)(Input, { ...field }) }),
              (0, import_jsx_runtime.jsx)(Form.ErrorMessage, {})
            ] });
          }
...
var CampaignEdit = () => {
  ...
  return (0, import_jsx_runtime2.jsxs)(RouteDrawer, { children: [
    (0, import_jsx_runtime2.jsxs)(RouteDrawer.Header, { children: [
      (0, import_jsx_runtime2.jsx)(RouteDrawer.Title, { asChild: true, children: (0, import_jsx_runtime2.jsx)(Heading, { children: t2("campaigns.edit.header") }) }),
      (0, import_jsx_runtime2.jsx)(RouteDrawer.Description, { asChild: true, children: (0, import_jsx_runtime2.jsx)(VisuallyHidden, { children: t2("campaigns.edit.description") }) })
    ] }),
    !isLoading && campaign && (0, import_jsx_runtime2.jsx)(EditCampaignForm, { campaign })
  ] });
};
export {
  CampaignEdit as Component
};
//# sourceMappingURL=campaign-edit-U6GDSJ6T-WIBFFY4O.js.map
