...
// node_modules/@medusajs/dashboard/dist/collection-metadata-5HHQNOAJ.mjs
...
var CollectionMetadata = () => {
  ...
  const { mutateAsync, isPending: isMutating } = useUpdateCollection(
    collection == null ? void 0 : collection.id
  );
  if (isError) {
    throw error;
  }
  return (0, import_jsx_runtime.jsx)(
    MetadataForm,
    {
      metadata: collection == null ? void 0 : collection.metadata,
      hook: mutateAsync,
      isPending,
      isMutating
    }
...
//# sourceMappingURL=collection-metadata-5HHQNOAJ-JXULJKN4.js.map
