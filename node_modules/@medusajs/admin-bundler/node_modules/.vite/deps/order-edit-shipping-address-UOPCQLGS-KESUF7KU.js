...
// node_modules/@medusajs/dashboard/dist/order-edit-shipping-address-UOPCQLGS.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var import_jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var EditOrderShippingAddressSchema = objectType({
...
function EditOrderShippingAddressForm({
  ...
  const form = useForm({
    defaultValues: {
      address_1: ((_a = order.shipping_address) == null ? void 0 : _a.address_1) || "",
      address_2: ((_b = order.shipping_address) == null ? void 0 : _b.address_2) || "",
      city: ((_c = order.shipping_address) == null ? void 0 : _c.city) || "",
      company: ((_d = order.shipping_address) == null ? void 0 : _d.company) || "",
      country_code: ((_e = order.shipping_address) == null ? void 0 : _e.country_code) || "",
      phone: ((_f = order.shipping_address) == null ? void 0 : _f.phone) || "",
      postal_code: ((_g = order.shipping_address) == null ? void 0 : _g.postal_code) || "",
      province: ((_h = order.shipping_address) == null ? void 0 : _h.province) || ""
    },
    resolver: t(EditOrderShippingAddressSchema)
  });
  ...
  const handleSubmit = form.handleSubmit(async (data) => {
    try {
      ...
      toast.success(t2("orders.edit.shippingAddress.requestSuccess"));
      handleSuccess();
    } catch (error) {
...
var OrderEditShippingAddress = () => {
  ...
  return (0, import_jsx_runtime2.jsxs)(RouteDrawer, { children: [
    (0, import_jsx_runtime2.jsx)(RouteDrawer.Header, { children: (0, import_jsx_runtime2.jsx)(Heading, { children: t2("orders.edit.shippingAddress.title") }) }),
    order && (0, import_jsx_runtime2.jsx)(EditOrderShippingAddressForm, { order })
  ] });
};
export {
  OrderEditShippingAddress as Component
};
//# sourceMappingURL=order-edit-shipping-address-UOPCQLGS-KESUF7KU.js.map
