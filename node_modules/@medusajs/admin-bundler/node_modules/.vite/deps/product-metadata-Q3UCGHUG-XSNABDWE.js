...
// node_modules/@medusajs/dashboard/dist/product-metadata-Q3UCGHUG.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var ProductMetadata = () => {
  const { id } = useParams();
  const { product, isPending, isError, error } = useProduct(id);
  const { mutateAsync, isPending: isMutating } = useUpdateProduct(product == null ? void 0 : product.id);
  if (isError) {
    throw error;
  }
  return (0, import_jsx_runtime.jsx)(
    MetadataForm,
    {
      metadata: product == null ? void 0 : product.metadata,
      hook: mutateAsync,
      isPending,
      isMutating
    }
...
//# sourceMappingURL=product-metadata-Q3UCGHUG-XSNABDWE.js.map
