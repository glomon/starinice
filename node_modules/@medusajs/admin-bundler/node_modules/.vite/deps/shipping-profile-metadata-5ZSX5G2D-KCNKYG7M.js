...
// node_modules/@medusajs/dashboard/dist/shipping-profile-metadata-5ZSX5G2D.mjs
...
var ShippingProfileMetadata = () => {
  ...
  const { mutateAsync, isPending: isMutating } = useUpdateShippingProfile(
    shipping_profile == null ? void 0 : shipping_profile.id
  );
  if (isError) {
    throw error;
  }
  return (0, import_jsx_runtime.jsx)(
    MetadataForm,
    {
      metadata: shipping_profile == null ? void 0 : shipping_profile.metadata,
      hook: mutateAsync,
      isPending,
      isMutating
    }
...
//# sourceMappingURL=shipping-profile-metadata-5ZSX5G2D-KCNKYG7M.js.map
