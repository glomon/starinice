...
// node_modules/@medusajs/dashboard/dist/store-metadata-G5WQCXQV.mjs
var import_jsx_runtime = __toESM(require_jsx_runtime(), 1);
var StoreMetadata = () => {
  const { store, isPending, isError, error } = useStore();
  const { mutateAsync, isPending: isMutating } = useUpdateStore(store == null ? void 0 : store.id);
  if (isError) {
    throw error;
  }
  return (0, import_jsx_runtime.jsx)(RouteDrawer, { children: (0, import_jsx_runtime.jsx)(
    MetadataForm,
    {
      ...
      isMutating,
      hook: mutateAsync,
      metadata: store == null ? void 0 : store.metadata
    }
  ) });
};
export {
...
//# sourceMappingURL=store-metadata-G5WQCXQV-6L3JFUWA.js.map
